...
- (AudioManager *)init
{
  self = [super init];
  if (self) {
    self.audioPlayer = [[STKAudioPlayer alloc] initWithOptions:(STKAudioPlayerOptions){ .readBufferSize = 20 }];
...
RCT_EXPORT_METHOD(play)
{
  ...
  if (self.audioPlayer.state == STKAudioPlayerStatePaused) {
    ...
    [self.audioPlayer play:@"http://62.210.180.173:12345/salut-radio-128.aac"];
  }
}
...
- (void)setNowPlayingInfo
{
  ...
  NSDictionary *nowPlayingInfo = [NSDictionary dictionaryWithObjectsAndKeys:@"La radio de les salut c'est cool", MPMediaItemPropertyAlbumTitle, @"", MPMediaItemPropertyAlbumArtist, @"Salut c'est cool", MPMediaItemPropertyTitle, artwork, MPMediaItemPropertyArtwork, nil];
